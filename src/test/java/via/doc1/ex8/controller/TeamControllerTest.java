...
public class TeamControllerTest {
    ...
    public void getTaskDetailsTest() throws Exception {
        ...
        // supplied
        when(teamService.getTask(anyString(),
                anyString())).thenReturn(mockTask);
    ...
    @Test
    public void getTaskDetailsTest1() {
        ...
        // Setting up the behavior of teamService.getTask()
        when(teamService.getTask("Member1", "Task1")).thenReturn(mockTask);

        // Calling the method under test
        Task result = teamController.getTaskDetails("Member1", "Task1");

        // Verifying that teamService.getTask() was called with the correct arguments
        verify(teamService).getTask("Member1", "Task1");

        // Asserting the returned Task object
